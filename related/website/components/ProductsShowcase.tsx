  ...
  return (
    <main ref={rootRef} className="prod-page editorial-page">
      ...
      <style>{`
        ...
        .prod-slide { position: absolute; top: 50%; left: 50%; z-index: 0; isolation: isolate; width: var(--center-width); height: 100%; overflow: hidden; border: 1px solid rgba(255,255,255,.78); border-radius: 38px; background: linear-gradient(118deg, rgba(255,255,255,.56) 0%, rgba(255,255,255,.26) 52%, rgba(244,247,255,.18) 100%); color: var(--ink); box-shadow: inset 0 1px 0 rgba(255,255,255,.92), inset 0 -1px 0 rgba(255,255,255,.28), 0 24px 70px rgba(43,54,86,.13), 0 6px 20px rgba(43,54,86,.06), 0 0 55px 8px rgba(142,174,255,.28), 0 0 104px 20px rgba(194,154,240,.2); -webkit-backdrop-filter: blur(30px) saturate(160%); backdrop-filter: blur(30px) saturate(160%); transform: translate(-50%,-50%) rotateY(0deg); transition: left .68s cubic-bezier(.22,1,.36,1), width .68s cubic-bezier(.22,1,.36,1), height .68s cubic-bezier(.22,1,.36,1), transform .68s cubic-bezier(.22,1,.36,1), opacity .4s ease, background .5s ease, box-shadow .68s ease; }
        ...
        .prod-slide[data-slot="center"] { left: 50%; z-index: 2; width: var(--center-width); height: 100%; opacity: 1; box-shadow: inset 0 1px 0 rgba(255,255,255,.95), inset 0 -1px 0 rgba(255,255,255,.32), inset 0 0 42px 5px rgba(73,142,255,.75), inset 0 0 86px 16px rgba(171,99,244,.58), 0 24px 70px rgba(43,54,86,.12), 0 6px 20px rgba(43,54,86,.05), 0 0 45px 5px rgba(255,255,255,.55), 0 0 82px 12px rgba(142,174,255,.46), 0 0 132px 28px rgba(194,154,240,.34); }
