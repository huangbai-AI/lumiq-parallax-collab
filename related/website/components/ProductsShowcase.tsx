  ...
  return (
    <main ref={rootRef} className="prod-page editorial-page">
      ...
      <style>{`
        ...
        .prod-stage-media { position: relative; z-index: 1; display: block; width: 100%; min-width: 0; align-self: stretch; aspect-ratio: 1 / 1; overflow: hidden; border: 1px solid rgba(255,255,255,.72); border-radius: 28px; background: linear-gradient(135deg, rgba(255,255,255,.34) 0%, rgba(255,255,255,.16) 48%, rgba(227,235,255,.18) 100%); color: inherit; box-shadow: inset 0 1px 0 rgba(255,255,255,.82), inset 0 -1px 0 rgba(255,255,255,.2), 0 18px 44px rgba(43,54,86,.08); -webkit-backdrop-filter: blur(22px) saturate(150%); backdrop-filter: blur(22px) saturate(150%); }
        .prod-stage-media::before { content: ""; position: absolute; z-index: 1; inset: 0; pointer-events: none; background: linear-gradient(120deg, rgba(255,255,255,.3), transparent 35%, rgba(218,227,255,.1) 70%, rgba(255,255,255,.2)); }
        ...
        .prod-autoplay-progress { position: relative; z-index: 3; grid-column: 1 / -1; width: 100%; height: 4px; overflow: hidden; border: 1px solid rgba(255,255,255,.55); border-radius: 999px; background: rgba(255,255,255,.2); box-shadow: inset 0 1px 2px rgba(255,255,255,.65), 0 1px 4px rgba(43,54,86,.08); -webkit-backdrop-filter: blur(10px) saturate(135%); backdrop-filter: blur(10px) saturate(135%); }
