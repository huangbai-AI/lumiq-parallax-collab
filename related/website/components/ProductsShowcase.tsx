  ...
  return (
    <main ref={rootRef} className="prod-page editorial-page">
      ...
      <style>{`
        ...
        .prod-glow-sweep { position: absolute; top: 50%; left: 50%; width: max(160vw, 160vh); height: max(160vw, 160vh); background: conic-gradient(rgba(151, 185, 201, .55) 0deg, rgba(137, 177, 203, .82) 58deg, rgba(177, 187, 209, .42) 130deg, rgba(171, 158, 201, .76) 205deg, rgba(204, 180, 199, .48) 296deg, rgba(151, 185, 201, .55) 360deg); transform: translate(-50%, -50%); animation: prod-glow-flow 40s linear infinite; }
