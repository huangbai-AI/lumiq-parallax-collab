  ...
  return (
    <main ref={rootRef} className="prod-page editorial-page">
      ...
      <style>{`
        ...
        .prod-glow-band { --spread: 3px; position: absolute; inset: calc(-.5 * var(--spread)); border-radius: calc(var(--card-radius) + .5 * var(--spread)); filter: blur(3px); opacity: .45; }
        .prod-glow-band--edge { --spread: 2px; filter: blur(1.4px); opacity: 1; }
